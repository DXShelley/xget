...
- `https://fast.dxshelley.fun/search?q=hermes` 会快捷跳转到 `https://git.dxshelley.fun/DXShelley/xget`。
- `https://git.dxshelley.fun/[所有者]/[存储库]` 及其 `tree`、`blob`、`commits`、`branches` 等页面由本域代理。
